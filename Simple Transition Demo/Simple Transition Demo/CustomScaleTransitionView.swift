//
//  CustomScaleTransitionView.swift
...
struct CustomScaleTransitionView: View {
...
struct CustomScaleTransitionView_Previews: PreviewProvider {
    static var previews: some View {
        CustomScaleTransitionView()
    }
}
