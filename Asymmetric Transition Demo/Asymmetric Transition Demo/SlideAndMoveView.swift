     ...
     @State var flag = false
       ...
       var body: some View {
           VStack{
               ...
               Spacer()
           }.navigationBarTitle("Slide and Move Transition", displayMode: .automatic)
       }
}

struct SlideAndMoveView_Previews: PreviewProvider {
